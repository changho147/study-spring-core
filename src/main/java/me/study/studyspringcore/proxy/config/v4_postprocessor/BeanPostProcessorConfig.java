package me.study.studyspringcore.proxy.config.v4_postprocessor;
...
import me.study.studyspringcore.proxy.config.v4_postprocessor.postprocessor.PackageLogTraceProxyPostProcessor;
...
public class BeanPostProcessorConfig {
    ...
    public PackageLogTraceProxyPostProcessor logTraceProxyPostProcessor(LogTrace logTrace) {
        return new PackageLogTraceProxyPostProcessor("me.study.studyspringcore.proxy.app", getAdvisor(logTrace));
    }
